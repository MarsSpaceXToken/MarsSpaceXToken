...
contract MarsSpaceXToken is IBEP20, Auth {
  using SafeMath for uint256;
  ...
  string constant _name = "MarsSpaceXToken";
  string constant _symbol = "MPX";
  ...
  constructor() Auth(msg.sender) {
    ...
    marketingFeeReceiver = 0xe319Bb1Ea63a754776B049cFDded8448F1EC8F9D;
    devFeeReceiver = 0x28280410f8099e34A488C21263221af428747ed4;
